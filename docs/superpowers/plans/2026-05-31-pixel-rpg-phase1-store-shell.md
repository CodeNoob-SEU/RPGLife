...
export function QuestsScreen() {
  // Select the STABLE array ref, then filter in the render body. Filtering inside the
  // selector returns a new array every render → zustand (Object.is) loops forever (React #185).
